    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center">
        <div className="text-center">
          <div className="text-2xl font-bold text-gray-800 mb-2">Loading league data...</div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Football League Manager</h1>
          <p className="text-gray-600">Record match results and track league standings</p>
          <p className="text-sm text-green-600 font-semibold mt-2">✓ Connected to cloud database</p>
        </div>
